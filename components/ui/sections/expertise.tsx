    ...
    return (
        ...
        >
            <h2 id="expertise-heading" className="text-center text-4xl sm:text-5xl font-extrabold tracking-tight">
                <span>My&nbsp;</span>
                <span className="text-(--brand-name)">Expertise</span>
                <span className="mx-1 text-(--brand-dot)">.</span>
                <span className="text-(--brand-underscore)">_</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 items-stretch auto-rows-[1fr] gap-5 sm:gap-6">
                <ExpertiseItem
                    icon={<Monitor className="h-8 w-8 text-(--brand-name)" />}
                    title="Backend"
                ...
                <ExpertiseItem
                    icon={<Atom className="h-8 w-8 text-(--brand-name)" />}
                    title="Frontend"
                ...
                <ExpertiseItem
                    icon={<Smartphone className="h-8 w-8 text-(--brand-name)" />}
                    title="Mobile"
